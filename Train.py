...
def train_model(model, dataloaders, criterion, optimizer, class_names, dataset_sizes, Augmentation=None, edge_size=384,
                model_idx=None, num_epochs=5, intake_epochs=0, check_minibatch=100, scheduler=None, device=None,
...
def main(args):
    ...
    # Augmentation
    Augmentation = get_online_augmentation(augmentation_name, p=0.6667, class_num=num_classes,
